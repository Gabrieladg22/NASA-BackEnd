...
public class UserManagerCli {
    ...
    public void showNeo(){
        if(loggedInUser == null){
            System.out.println("Sorry. Only logged in users can see near earth objects info.");
        ...
        LocalDate date = null;
        System.out.println("Please Enter Date to show NEOs (hit enter for today's date or YYYY-MM-DD for a different date: ");
    ...
    public void displayNeoObjects(NeoFeedResponse response, LocalDate date){
        ...
        System.out.println("Save this Neo to the database(y/n)? ");
        if(userInput.nextLine().equalsIgnoreCase("y")){
            System.out.println("Enter the Neo Id to save: ");
            boolean isFound = false;
            String neoChose = userInput.nextLine();
            for (Neo n : neoList) {
                if (n.getId().equalsIgnoreCase(neoChose)){
...
//            loggedInUser.setUsername(username);
    ...
    private void printGreeting() {
        System.out.println("Welcome to the Near Earth Object Application!");
        System.out.println();
    }
}
